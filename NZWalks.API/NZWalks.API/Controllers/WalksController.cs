...
namespace NZWalks.API.Controllers
{
    ...
    public class WalksController : Controller
    {
        ...
        public async Task<IActionResult> GetWalkAsync(Guid id)
        {
            ...
            var walkDomin = await walkRepository.GetWalkAsync(id);
        ...
        [Route("{name:alpha}")]
        [ActionName("GetWalkAsync")]
        public async Task<IActionResult> GetWalkAsync(string name)
        {
            // Get Walk Domain object from database
            var walkDomin = await walkRepository.GetWalkAsync(name);

            // Convert Domain object to DTO
            var walkDTO = mapper.Map<List<Models.DTO.Walk>>(walkDomin);
